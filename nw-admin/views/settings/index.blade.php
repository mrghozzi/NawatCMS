        ...
        <div class="panel-body">
            <form action="{{ route('admin.settings.update') }}" method="POST">
                ...
                <div class="form-group">
                    <label for="site_name">Site Name <span lang="ar" dir="rtl">اسم الموقع</span></label>
                ...
                <div class="form-group">
                    <label for="site_description">Site Description <span lang="ar" dir="rtl">وصف الموقع</span></label>
                ...
                <div class="form-group">
                    <label for="admin_email">Administration Email <span lang="ar" dir="rtl">بريد الإدارة</span></label>
