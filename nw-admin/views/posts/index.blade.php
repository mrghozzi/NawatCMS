...
@section('content')
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
        <h2 style="margin: 0; font-size: 20px;">All Posts <span lang="ar" dir="rtl" style="font-size: 14px; color: var(--muted); margin-inline-start: 8px;">جميع المقالات</span></h2>
                ...
                @forelse($posts as $post)
                    <tr style="border-bottom: 1px solid var(--border);">
                        ...
                        <td style="padding: 16px 24px; text-align: end;">
                            <a href="{{ route('admin.posts.edit', $post) }}" style="color: var(--accent); text-decoration: none; font-size: 14px; margin-inline-end: 12px; font-weight: 500;">Edit</a>
